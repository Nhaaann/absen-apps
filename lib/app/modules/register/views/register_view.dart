...
import 'package:absen_app/app/routes/app_pages.dart';
...
class RegisterView extends GetView<RegisterController> {
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 48),
                _Input(auth.nameController, "name"),
                SizedBox(height: 24),
                ...
                InkWell(
                  onTap: () {
                    ...
                    var confirmPw = controller.confirmPasswordController.text;
                    if (email != "" && password != "" && confirmPw != "") {
                      if (password == confirmPw) {
                        ...
                        Get.defaultDialog(
                          title: "Error",
                          middleText: "Konfirmasi password tidak sama",
                          textConfirm: "OK",
                ...
                Row(
                  ...
                  children: [
                    ...
                    Gap(24),
                    _Icon("icons/google-icon.svg"),
                    Gap(24),
                    _Icon("icons/phone_number.svg"),
                  ],
                ),
              ],
            ),
  ...
  TextField _Input(TextEditingController controllers, String label) {
    return TextField(
